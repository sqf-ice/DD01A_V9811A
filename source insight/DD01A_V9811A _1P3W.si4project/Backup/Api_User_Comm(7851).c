...
//日冻结
	0x0506FF01,    0x0000,	  EN_R+P_E2P1, 5,10,
	0x0506FF02,    0x0000,	  EN_R+P_E2P1, 5,10,
	0x0506FF03,    0x0000,	  EN_R+P_E2P1, 5,10,
	0x0506FF03,    0x0000,	  EN_R+P_E2P1, 5,10,
...
CLRWDT(); 
    ...
    {	
		...
		//	  Lib_BCD_AscA(sptr+2+10, &data_buff[0], 4);	
			  ...
			  mem_read(&te, st_mmd_unit_array[1].buf[0], LEN_NEW_MMD_UNIT, MEM_RAM);//需量
		//	  Lib_long_bcd4(sptr+2+10+8,t.val.val_hex32);
		//	  mem_read(&t, sum_st_mmd_unit_array[1].buf[0], LEN_SUM_MMD_UNIT, MEM_RAM);//累计需量
		//	  Lib_long_bcd4(sptr+2+10+8+8,t.val.val_hex32);
...
//			  Lib_long_bcd4(sptr+2+10+8+8+8,t.val.val_count);//次数
		break;

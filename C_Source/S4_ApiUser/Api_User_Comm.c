 ...
 code IEC_COMDISTAB    IEC_ComDisTab[] =
{
...
#endif	
	//无功
	0x00030000, &gs_energy_user_data.us_val[EC_CH_RE_PT_TT][TARIFF_T].buf[0],	EN_R+P_RAM,	4,8,  //总
#if (TARIFF_MAX_NUM>0)//四费率
	...
	0x010100FF,	&sum_st_mmd_unit_array[0].buf[0],	EN_R+P_RAM,	5,10, //当前累计最大需量
#if (BILL_MAX_NUM>0)
	...
	0x04000B02,ADR_BLOCK20_METER_PARAM1_E2P+ST_MB_OFFSET(E2P_METER_PARAM1_MAP,BILL_FLAG), EN_RW+P_E2P1,1,2,	 //结算方式
